  ...
  return (
    <main className="mx-auto max-w-md px-4 py-10">
      ...
      <form action={updateOrganizationLogo} className="mt-6 grid gap-4 rounded-lg border border-gray-200 p-4">
        ...
        {logo === "actualizado" && <p className="text-sm text-emerald-600">Logo actualizado correctamente.</p>}
      ...
      <div>
        {ubicacion === "actualizada" && (
          <p className="text-sm text-emerald-600">Ubicación actualizada correctamente.</p>
        )}
